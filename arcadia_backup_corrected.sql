...
INSERT INTO `comments` VALUES (1,'Fan De Zoo','Bonjour ! Super Exp%rience ! je vais surement revenir un bon milliers de fois !','2024-07-10 13:01:31',0),(2,'L%onard Sauvage',' Le zoo Arcadia a %t% une exp%rience d%licieuse pour notre famille. Le personnel %tait sympathique et les installations bien entretenues.','2024-07-10 13:06:26',1),(3,'Clara Loutre','Notre visite au zoo Arcadia a d%pass% nos attentes. Les efforts de conservation et les programmes %ducatifs %taient impressionnants.','2024-07-10 13:06:50',1),(4,'Pauline Grisouille','Notre visite au zoo Arcadia a %t% une exp%rience merveilleuse ! La diversit% des animaux et les expositions interactives ont rendu notre visite inoubliable.','2024-07-10 13:07:18',1),(5,'Mr Test','Ceci est un test pour voir le bon fonctionnement du syst%me d\'avis!','2024-07-11 11:15:02',1),(6,'Mme Test','Ceci est un test qui fait suite au nettoyage du code','2024-07-11 14:14:34',1);
...
INSERT INTO `services` VALUES (4,'Visite des habitats avec un guide (gratuit)','Explorez nos habitats fascinants en compagnie de guides exp%riment%s. Apprenez-en davantage sur nos r%sidents % plumes et % %cailles tout en d%couvrant nos efforts de conservation et de pr%servation de la biodiversit%.','img/icones/guide.png'),(5,'Restauration sur place ','D%gustez une vari%t% de d%lices culinaires tout en profitant de la beaut% naturelle de notre parc. Nos options de restauration sauront combler toutes vos envies, que vous soyez en qu%te d\'une collation rapide ou d\'un repas complet en famille.','img/icones/restau.png'),(6,'Visite du zoo en petit train','Montez % bord de notre petit train et laissez-vous transporter % travers les diff%rents secteurs du zoo. Profitez d\'une perspective unique tout en apprenant des faits int%ressants sur nos animaux et leur habitat naturel.','img/icones/train.png');
